...
go run ./cmd/discovery --pcap /path/to/file.pcap --output path/to/output/directory
...
- thu thập một số thông tin cơ bản của asset từ traffic (ví dụ: IP, MAC, first seen, last seen, hostname, ...),
